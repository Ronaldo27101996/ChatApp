...
import com.example.cr7.chatapp.EditInfoActivity;
import com.example.cr7.chatapp.MapActivity;
...
/**
 * Created by CR7 on 4/7/2018.
 */

public class Fragment_ListConversation extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_listconversation,container,false);
        addControls(view);
        addEvents();
        return view;
    }
    ...
    private void addControls(View view) {
        ...
        adapterConversation =new AdapterConversation(listConversation,getActivity());
